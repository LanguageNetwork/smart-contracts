...
const LanguageTokenICO = artifacts.require('LanguageTokenICO');
const LanguageToken = artifacts.require('LanguageToken');
const RefundVault = artifacts.require('RefundVault');

contract('LanguageTokenICO', function ([owner, wallet, investor]) {
  ...
  beforeEach(async function () {
    ...
    this.token = await LanguageToken.new({ from: owner });
    this.vault = await RefundVault.new(wallet, { from: owner });
    this.crowdsale = await LanguageTokenICO.new(
